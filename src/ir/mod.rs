...
// todo: visitor pattern for better visiting and translating ast to ir?
sum_type! {
...
pub fn bbs(code: &str) -> IResult<&str, Vec<BasicBlock>> {
    many0(delimited(multispace0, basic_block::parse, multispace0))(code)
}
...
mod tests {
    ...
    fn it_works() {
        ...
        //         many0(map(
        //             tuple((multispace0, parse, opt(line_ending))),
        //             |(_, result, _)| result,
        //         ))(code)
        //     };
