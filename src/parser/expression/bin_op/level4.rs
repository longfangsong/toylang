...
use crate::parser::expression::bin_op::level3::{self, higher_than_level3};
...
pub(in crate::parser::expression) fn higher_than_level4(code: &str) -> IResult<&str, RValue> {
    alt((map(level3::parse, |binop| binop.into()), higher_than_level3))(code)
}
