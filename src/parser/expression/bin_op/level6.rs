...
use crate::parser::expression::bin_op::level5::higher_than_level5;
use crate::parser::expression::bin_op::{level5, BinOp};
...
pub(in crate::parser::expression) fn higher_than_level6(code: &str) -> IResult<&str, RValue> {
    alt((map(level5::parse, |binop| binop.into()), higher_than_level5))(code)
}
